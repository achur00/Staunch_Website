...
<div class="main-content">
  <div class="d-flex justify-content-between">
    <h2 class="p-3">Edit project</h2>
    <div class="clearfix m-3">
      <a href="{{ route('projects.index') }}" class="btn btn-primary float-right fa fa-arrow-left"></a>
    </div>
  </div>
  <!-- Page content -->
        ...
        <div class="card-wrapper">
          ...
          <div class="card pb-2">
            ...
            <div class="card-header">
              <h3 class="mb-0">Edit project Details</h3>
            </div>
            <!-- Card body -->
            <div class="card-body">
              <form method="POST" id="act" action="{{ route('projects.update', $project) }}" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="row">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <div class="input-group input-group-merge">
                      ...
                      <select name="project_category" id="cat"
                        ...
                        <option value="{{ $key }}" {{ $project->product_category_id == $key ? "selected" : "" }}>
                          {{ $value }}
                        </option>
                        @endforeach
                      </select>
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <div class="input-group input-group-merge">
                      ...
                      <input type="text" name="tools" value="{{$project->tools}}"
                        class="form-control @error('name') is-invalid @enderror" placeholder="{{__('project Tools e.g (PHP, LARAVEL, BOOTSTRAP 5)')}}"
                        required autocomplete="tools" autofocus>
                      @error('tools')
                      <span class="invalid-feedback text-danger" role="alert">
                        <strong>{{ $message }}</strong>
                      </span>
                  ...
                  <div class="form-group col-12">
                    ...
                    {{-- <div class="input-group input-group-merge"> --}}
                      ...
                      <input type="hidden" name="description" id="description" value="{{ $project->description ?? old('description') }}">
                ...
                <div class="row">
                  ...
                  <div class="col-12 mt-1 text-right">
                    <input type="submit" class="btn btn-primary mt-0 px-3" value="{{ __('Update project') }}">
                  </div>
                </div>
              </form>
            </div>
