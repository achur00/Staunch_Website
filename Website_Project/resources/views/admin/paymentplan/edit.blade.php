...
<div class="main-content">
    <div class="d-flex justify-content-between">
        <h2 class="p-3">Update payment plan Name</h2>
        <div class="clearfix m-3">
            <a href="{{ route('paymentplan.index') }}" class="btn btn-primary float-right fa fa-arrow-left"></a>
        </div>
    </div>
    <!-- Page content -->
                ...
                <div class="card-wrapper">
                    ...
                    <div class="card pb-2">
                        ...
                        <div class="card-header">
                            <h3 class="mb-0">Update payment plan Name</h3>
                        </div>
                        <!-- Card body -->
                        <div class="card-body">

                            <form method="POST" action="{{ route('paymentplan.update', $paymentplan) }}">
                                @method('PUT')
                                @csrf
