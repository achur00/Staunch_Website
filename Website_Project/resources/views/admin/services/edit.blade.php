...
<div class="main-content">
  <div class="d-flex justify-content-between">
    ...
    <div class="clearfix m-3">
      <a href="{{ route('services.index') }}" class="btn btn-primary float-right fa fa-arrow-left"></a>
    </div>
  </div>
      ...
      <div class="col-lg-8 col-md-9">
        ...
        <div class="card-wrapper">
          ...
          <div class="card pb-2">
            ...
            <!-- Card body -->
            <div class="card-body">
              <form method="POST" id="act" action="{{ route('services.update', $service) }}" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="row">
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <div class="input-group input-group-merge">
                      ...
                      <select name="service_category" id="cat"
                        ...
                        <option value="{{ $key }}" {{ $service->service_category_id == $key ? "selected" : "" }}>
                          {{ $value }}
                        </option>
                        @endforeach
                      </select>
                  ...
                  <div class="form-group col-lg-6">
                    ...
                    <div class="input-group input-group-merge">
                      ...
                      <input type="phone" name="phone" value="{{$service->phone}}"
                        class="form-control @error('name') is-invalid @enderror"
                        placeholder="{{__('Customer Care Phone')}}" required autocomplete="phone" id="phone" autofocus>
                      @error('phone')
                  ...
                  <div class="form-group col-12">
                    ...
                    {{-- <div class="input-group input-group-merge"> --}}
                      ...
                      <input type="hidden" name="description" id="description" value="{{ $service->description ?? old('description') }}">
                ...
                <div class="row">
                  ...
                  <div class="col-12 mt-1 text-right">
                    <input type="submit" class="btn btn-primary mt-0 px-3" value="{{ __('Update Service') }}">
                  </div>
                </div>
              </form>
            </div>
