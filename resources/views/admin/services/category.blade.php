...
<div class="main-content">
    <h2 class="p-3">Service Category</h2>
                ...
                <div class="card-wrapper">
                    ...
                    <div class="card pb-2">
                        ...
                        <div class="card-header bg-gradient-danger">
                            <h3 class="mb-0">Craete New Service Category</h3>
                        </div>
                        <!-- Card body -->
                        <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12 mx-auto">
                                        <div class="form-group">
                                            <label for="name">Service Category Name<span
                                            ...
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="text" name="name"
                                                    ...
                                                    placeholder="Service Category Name" id="name">
            ...
            <div class="col-lg-7 col-md-10 order-lg-1">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="mb-0">All Service Categories</h3>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="table-action">
                                        <a href="{{route('service.category.edit', $category)}}" class="table-action"
                                            data-toggle="tooltip" data-original-title="Edit service category">

                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="#!" class="table-action table-action-delete" data-toggle="modal"
                                            data-target="#delete{{$category->id}}" data-original-title="Delete category">
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <p>Are you sure you wanted to delete this Service category?.</p>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary"
                                                        data-dismiss="modal">Close</button>
                                                    <form method="POST" ,
                                                        action="{{ route('services.destroy', $category)}}" class="">
                                                        @csrf
                                                        @method('DELETE')
                                                        <div class="form-group">
