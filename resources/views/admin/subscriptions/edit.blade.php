        ...
        $.ajax({
                  ...
                  success:function(data) {                 
                    ...
                    data.forEach( pricing => {
                        price_select.innerHTML +=(`<option value="${ pricing.id }" ${ (pricing.id == {{ $subscription->pricing_id}}) ? "selected" : ""}> ${pricing.paymentplan.name} (₦${pricing.amount.toLocaleString('en-Us')})</option>`);
                    });
                  },
                  error:function(data) {    
...
<div class="main-content">
    <h2 class="p-3">Update Service Subscription</h2>
                ...
                <div class="card-wrapper">
                    ...
                    <div class="card pb-2">
                        ...
                        <div class="card-header">
                            <h3 class="mb-0 text-warning">Update Client Subscription</h3>
                        </div>
                        <!-- Card body -->
                        <div class="card-body">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <select name="user_id" id="user"
                                                ...
                                                <option value="{{ $client->id }}"
                                                    {{ $subscription->user->id == $client->id ? "selected" : "" }}>
                                                    {{ $client->email }}</option>
                                                @endforeach
                                                {{-- {{ $client->name}} --}} 
                                            </select>
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <select name="service_id" id="service"
                                                ...
                                                <option value="{{ $key }}"
                                                    {{ $subscription->service->id == $key ? "selected" : "" }}>
                                                    {{ $value }}
                                                </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-merge">
                                                ...
                                                <input type="number" name="paid" min="0" value="{{ $subscription->paid }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="example-datetime-local-input" class="form-control-label">Select
                                                ...
                                                <?php $d = $subscription->start->format('Y-m-d');
                                                $t = $subscription->start->format('H:i:s'); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="example-datetime-local-input" class="form-control-label">Select
                                                ...
                                                <?php $d2 = $subscription->due->format('Y-m-d');
                                                $t2 = $subscription->due->format('H:i:s'); ?>
                                            <input class="form-control" name="due" type="datetime-local"
                                                value="{{ $d2."T".$t2 }}" id="example-datetime-local-input" />
