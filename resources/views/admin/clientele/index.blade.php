                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="table-action">
                      <a href="{{route('clients.edit', $user)}}" class="table-action" data-toggle="tooltip"
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <p>Are you sure you wanted to delete this Client?.</p>
                          </div>
