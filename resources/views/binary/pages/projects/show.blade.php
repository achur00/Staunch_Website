                                    ...
                                    <div class="slideshow_container flexslider slide_layout_" id="flex">
                                        <ul class="slides slide_flexslider">
                                            ...
                                            <li class="slide_element slide1 frame1"
                                                data-thumb="{{ asset('images/projects').'/'.$photo->name}}">
                                                <img src="{{ asset('images/projects').'/'.$photo->name}}"
            ...
            <aside class="span5 sidebar" id="widgetarea-sidebar">
                ...
                <div class="single_content" style="margin-bottom: 25px;">
                    <ul class="metas" style="padding-top: 0;">
                        ...
                        <li  style="background: none !important; padding-left: 0;">
                            <dl class="dl-horizontal">
                                <dt>DEMO:</dt>
                                <dd><a target="_blank" href="{{ $project->url }}">{{ $project->url }}</a></dd>
                            </dl>
                        </li>
                    </ul>
                </div>
                ...
                {{--<div id="categories-2" class="widget widget_categories">
                    ...
                    <ul>
                        ...
                        <li class="cat-item cat-item-8"><a href="{{ route('project.category.search', $project_cat) }}"
                                title="View all posts filed under News">{{ $project_cat->name }}</a>
                        </li>
                ...
                <div id="widget_most_popular-2" class="widget widget_most_popular">
                    ...
                    <ul>
                        ...
                        <li>
                            <dl class="dl-horizontal">
                                <dt><img src="{{ asset('images/projects').'/'.$p_project->photos[0]->name}}" alt="" style="width: 100%; height: 100%;">
                                </dt>
                                <dd><a href="{{ route('project.details', $p_project) }}">{{ $p_project->name }}</a>
                                    <p class="info">{{  $p_project->created_at->format('M.d, Y') }}</p>
                                </dd>
                            </dl>
